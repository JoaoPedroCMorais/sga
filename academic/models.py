...
@pghistory.track(
    pghistory.InsertEvent('student_created'),
    pghistory.UpdateEvent('student_updated')
)
class Student(models.Model):
    ...
    enrollment_number = models.CharField("Matrícula", max_length=20, unique=True, db_index=True)
